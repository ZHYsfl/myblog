---
title: 'OpenAI SDK Automatically Injects Tool Schema'
date: 2026-06-30
category: 'ai-infra'
tags: ['OpenAI SDK', 'Tool Schema', 'Context Engineering']
lang: 'en'
slug: 'openai-sdk-automatically-injects-tool-schema'
translationOf: 'openai-sdk-automatically-injects-tool-schema'
readingTime: 3
description: ''
---
